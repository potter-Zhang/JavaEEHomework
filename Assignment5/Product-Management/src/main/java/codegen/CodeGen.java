...
public class CodeGen {
    ...
    private static PackageConfig packageConfig() {
        ...
        packageInfo.setParent("whu.edu.Product.Management");
        //设置实体类包名
        packageInfo.setEntity("Models");
        //设置数据层包名
        packageInfo.setMapper("User");
        return packageInfo;
    }
    ...
    private static GlobalConfig globalConfig() {
        ...
        globalConfig.setOutputDir(System.getProperty("user.dir")
                +"/Product-Management/src/main/java");
        //设置生成完毕后是否打开生成代码所在的目录
        globalConfig.setOpen(false);
        //设置作者
        globalConfig.setAuthor("little_prince");
        //设置是否覆盖原始生成的文件
        globalConfig.setFileOverride(true);
        //设置数据层接口名，%s为占位符，指代模块名称
        globalConfig.setMapperName("I%s");
        //设置Id生成策略
